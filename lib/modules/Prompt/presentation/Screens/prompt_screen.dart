...
class _PromptScreenState extends State<PromptScreen> {
  ...
  @override
  void initState() {
    _controller = SimpleAnimation('lost in thought');
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border:
                                Border.all(width: 8, color: kSecondaryColor),
